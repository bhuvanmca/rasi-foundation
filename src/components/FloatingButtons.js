...
const FloatingButtons = () => {
  ...
  const whatsappMessage = encodeURIComponent('Hi! I would like to know more about Rasi Foundation courses and admissions.');
  ...
  return (
    <div className="fixed right-4 bottom-4 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="group flex items-center justify-center w-14 h-14 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
        aria-label="Call Us"
      >
